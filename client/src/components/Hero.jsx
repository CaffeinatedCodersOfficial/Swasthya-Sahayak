...
const Hero = () => {
  return (
    <div className='w-full h-[200dvh] pt-24 overflow-hidden flex flex-col justify-start items-center'>
      <div className='border-b-2 border-b-black/20 w-full h-[100dvh] rounded-b-full scale-110 flex justify-start flex-col items-center pt-20 relative'>
        ...
        <div className='flex justify-center items-center rounded-full  '>
            <form className='flex justify-center items-center rounded-full border-2 border-black/20 py-1 px-1 focus:border-black'>
                <input type="text" placeholder='Describe your problem' className='outline-none pl-3 pr-3'/>
      ...
      <div className='w-full h-[80dvh] flex justify-center items-center relative bg-transparent'>
        ...
        <div className='w-1/2 h-full pt-20 bg-transparent'>
          <h3 className='text-3xl ml-14 font-michrome mt-20 mb-2'>Live Well, Be Well</h3> 
          <p className='ml-14 pr-20 text-black/75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero consequuntur accusamus illum sapiente repudiandae! Enim at accusantium, alias quam ad quo exercitationem quis officia minima ullam a aliquam totam quibusdam!</p>

          <div className='ml-14 mt-10 flex justify-start items-center gap-20'>
            <div className='flex justify-center items-start flex-col'>
              <h3 className='text-5xl'>100+</h3>
              <p className='ml-1'>Hospitals</p>
            </div>
            <div className='flex justify-center items-start flex-col'>
              <h3 className='text-5xl'>1000+</h3>
              <p className='ml-1'>Doctors</p>
            </div>
            <div className='flex justify-center items-start flex-col'>
              <h3 className='text-5xl'>10000+</h3>
